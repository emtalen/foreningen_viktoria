      ...
      <div className="main-content">
        ...
        <div id="purpose-text">
          <p>
            ...
            i alla åldrar, oavsett bakgrund. Föreningen ska aktivt arbeta för
            att motverka all form av diskriminering.
          </p>
          <p>
            Utdelning <br/> 
            Utdelning sker varje år till material, hjälpmedel,
            aktivitet eller liknane som kanstödja den ansökande personen eller
            närstående, beslut fattas av föreningens Styrelse.
          </p>
        </div>
      </div>
    </div>
